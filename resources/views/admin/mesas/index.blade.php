        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('admin.mesas.create') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Crear nueva Mesa</a>
            </div>
                                            ...
                                            <td
                                                ...
                                                <div class="flex space-x-2">
                                                    ...
                                                    <form
                                                        ...
                                                        method="POST"
                                                        action="{{ route('admin.mesas.destroy', $mesa->id) }}"
