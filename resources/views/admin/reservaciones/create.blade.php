        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.reservaciones.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="sm:col-span-6">
                            <label for="nombre_completo" class="block text-sm font-medium text-gray-700"> Nombre </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="email" id="email" name="email"
                                    class="text-black w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('email') border-red-400 @enderror" />
                            </div>
                            @error('email')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="sm:col-span-6">
                            <label for="numero_telefonico" class="block text-sm font-medium text-gray-700"> Numero Telefonico </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6">
                            <label for="fecha_reservacion" class="block text-sm font-medium text-gray-700"> Fecha de Reservacion </label>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select id="mesa_id" name="mesa_id"
                                    ...
                                    <option value="{{$mesa->id}}">{{$mesa->nombre}} ({{$mesa->numero_persona}} Personas)</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('mesa_id')
