<x-navegar-layout>
    ...
    <div
        class="imagen container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center">
        <h1
            class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-800 to-amber-600 md:text-center sm:leading-none lg:text-5xl">
            <span class="inline md:block">Bienvenidos al Restaurante el "Jacalito"</span>
        </h1>
    ...
    <section class="px-2 py-32 bg-red-800 md:px-0">
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
            ...
            > -->
                        <h3 class="text-4xl text-yellow-300">Nuestra Historia
                        </h3>
                        <h2 class="text-xl text-yellow-600">Bienvenidos</h2>
                        <!-- </h1> -->
                        ...
                        <div class="relative flex">
                            ...
                            {!! QrCode::size(250)->generate('https://github.com') !!}
                            <a href="#_"
    ...
    <section class="py-12 bg-orange-900">
    ...
    <section class="px-2 py-2 bg-yellow-600">
        ...
        <div class="container w-full px-5 py-6 mx-auto">
            <div class="grid lg:grid-cols-4 gap-y-6">
                @foreach ($especiales->menus as $menu)
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg bg-red-700">
                        <img class="w-full h-48" src="{{ Storage::url($menu->imagen) }}" alt="Image" />
                        <div class="px-6 py-4">
                            <h4 class="mb-3 text-xl font-semibold tracking-tight text-yellow-400 uppercase">
                                {{ $menu->nombre }}</h4>
    ...
    <section class="py-12 bg-orange-900">
        <div class="container items-center max-w-6xl px-4 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        <h2 class="mb-4 text-2xl font-bold">Contactanos</h2>
                        <h2
                            class="mb-4 text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
                            ...
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <a href="https://es-la.facebook.com">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                        width="26" height="26" viewBox="0 0 48 48" style=" fill:#000000;">
                                ...
                                <a href="https://es-la.facebook.com">
                                    <span class="font-medium text-gray-500">Facebook</span>
                                </a>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <a href="https://es-la.facebook.com">
                                ...
                                <a href="https://es-la.facebook.com">
                                    <span class="font-medium text-gray-500">Twitter</span>
                                </a>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <a href="https://es-la.facebook.com">
                                ...
                                <a href="https://es-la.facebook.com">
                                    <span class="font-medium text-gray-500">Instagram</span>
                                </a>
                            </li>
                            <li class="flex items-center py-2 space-x-4 xl:py-3">
                                <a href="https://es-la.facebook.com">
                                ...
                                <a href="https://es-la.facebook.com">
                                    <span class="font-medium text-gray-500">WhatssApp</span>
                                </a>
                            </li>
                        </ul>
                    </div>
